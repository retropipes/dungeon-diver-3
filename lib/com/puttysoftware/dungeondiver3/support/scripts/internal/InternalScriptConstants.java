...
public class InternalScriptConstants {
    ...
    public static final int[] ARGUMENT_COUNT_VALIDATION = new int[] { InternalScriptConstants.ARGC_NONE,
	    InternalScriptConstants.ARGC_MESSAGE, InternalScriptConstants.ARGC_SOUND, InternalScriptConstants.ARGC_SHOP,
	    InternalScriptConstants.ARGC_MOVE, InternalScriptConstants.ARGC_DECAY, InternalScriptConstants.ARGC_REDRAW,
	    InternalScriptConstants.ARGC_SWAP_PAIRS, InternalScriptConstants.ARGC_ADD_TO_SCORE,
	    InternalScriptConstants.ARGC_RANDOM_CHANCE, InternalScriptConstants.ARGC_BATTLE,
	    InternalScriptConstants.ARGC_RELATIVE_LEVEL_CHANGE };
    // Argument Type Validation Array
    public static final Class<?>[][] ARGUMENT_TYPE_VALIDATION = new Class[][] { InternalScriptConstants.ARGT_NONE,
	    InternalScriptConstants.ARGT_MESSAGE, InternalScriptConstants.ARGT_SOUND, InternalScriptConstants.ARGT_SHOP,
	    InternalScriptConstants.ARGT_MOVE, InternalScriptConstants.ARGT_DECAY, InternalScriptConstants.ARGT_REDRAW,
	    InternalScriptConstants.ARGT_SWAP_PAIRS, InternalScriptConstants.ARGT_ADD_TO_SCORE,
	    InternalScriptConstants.ARGT_RANDOM_CHANCE, InternalScriptConstants.ARGT_BATTLE,
