...
public class SpellCaster {
    ...
    private static boolean castSpellWithPower(final Spell cast, final int power, final Creature caster,
	    final int teamID, final boolean aiEnabled, final BattleDefinitions battle) {
	if (cast != null) {
	    final int casterMP = caster.getCurrentMP();
