...
public class LocalPreferencesManager {
	...
	return LocalPreferencesManager.storeMgr.getBoolean("RandomBattleEnvironment", false);
    }
	...
	try (BufferedInputStream bis = new BufferedInputStream(
	    ...
	    LocalPreferencesManager.storeMgr.setBoolean("RandomBattleEnvironment", false);
	}
    }
}
