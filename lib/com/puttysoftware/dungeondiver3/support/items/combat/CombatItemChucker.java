...
public class CombatItemChucker {
    ...
    public static boolean useItem(final CombatItem used, final Creature user, final int teamID, final boolean aiEnabled,
	    final BattleDefinitions battle) {
	if (used != null) {
	    ...
	    used.use();
	    e.resetEffect();
	    final Creature[] targets = CombatItemChucker.resolveTarget(used, user, teamID, aiEnabled, battle);
    ...
    private static Creature[] resolveTarget(final CombatItem used, final Creature user, final int teamID,
