...
public class MapObjectList {
	...
	final MapObject[] allDefaultObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(),
		...
		new WhiteButton(), new YellowButton(), new CyanButton(), new Teleport(), new StairsUp(),
		new StairsDown(), new StairsInto(), new StairsOut(), new Pit(), new Springboard(), new EmptyVoid(),
		new ArmorShop(), new Bank(), new HealShop(), new ItemShop(), new Regenerator(), new SocksShop(),
		new SpellShop(), new WeaponsShop(), new EnhancementShop(), new FaithPowerShop() };
	...
	MapObject o = null;
	String UID = "";
	if (formatVersion == FormatConstants.SCENARIO_FORMAT_1 || formatVersion == FormatConstants.SCENARIO_FORMAT_2) {
