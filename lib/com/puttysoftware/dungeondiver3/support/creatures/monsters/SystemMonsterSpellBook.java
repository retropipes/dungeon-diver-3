...
class SystemMonsterSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_POISON);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.SELF, GameSoundConstants.SOUND_DEFENSIVE_MAGIC);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_DRAIN);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_DRAIN);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.SELF, GameSoundConstants.SOUND_DEFENSIVE_MAGIC);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.SELF, GameSoundConstants.SOUND_DEFENSIVE_MAGIC);
