...
public class AnnihilatorSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_COLD_DAMAGE);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ALL_ENEMIES, GameSoundConstants.SOUND_COLD_DAMAGE);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_MISSED);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ALL_ENEMIES, GameSoundConstants.SOUND_MISSED);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ALL_ENEMIES,
		GameSoundConstants.SOUND_OFFENSIVE_MAGIC);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ENEMIES, GameSoundConstants.SOUND_WEAKNESS);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ENEMY, GameSoundConstants.SOUND_DRAIN);
