...
public class BufferSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_POTION);
