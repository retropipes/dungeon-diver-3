...
public class CurerSpellBook extends SpellBook {
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ALL_ALLIES,
		GameSoundConstants.SOUND_DEFENSIVE_MAGIC);
	...
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ALLIES,
		GameSoundConstants.SOUND_DEFENSIVE_MAGIC);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ALLY, GameSoundConstants.SOUND_SCAN);
