...
class PreferencesGUIManager {
	...
	final JLabel generatorRandomnessValue = new JLabel("Generator Randomness");
	...
	this.checkBetaUpdatesStartup = new JCheckBox("Check for Pre-Release Updates at Startup", true);
