...
public class MenuManager {
    ...
    private JMenuItem gamePlay, gameEquipment, gameInventory, gamePickLeader, gameRegisterCharacter,
	    gameUnregisterCharacter, gameRemoveCharacter, gameEditNote, gameViewPrestige, gameViewScore, gameViewStats;
	...
	final ArrayList<GenericEditor> allEditors = DungeonDiver3.getApplication().getAllEditors();
