...
public abstract class GenericObjectEditor extends GenericEditor {
    ...
    protected GenericObjectEditor(final String newType, final String newSource, final int editorID,
	    final int actionCommandLength, final int actionButtonRows, final int actionButtonCols,
