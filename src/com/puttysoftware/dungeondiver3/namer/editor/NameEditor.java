...
public class NameEditor extends GenericObjectEditor {
    ...
    public NameEditor() {
	super("name", "Name Editor", Application.EDITOR_NAME, 2, 2, NamesConstants.NAMES_LENGTH, true);
	...
	this.cachedNames = DungeonDiver3.getApplication().getScenarioManager().getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
	DungeonDiver3.getApplication().getScenarioManager().getNamesFileManager().setNames(this.cachedNames);
    }

    @Override
    public void handleCloseWindow() {
	DungeonDiver3.getApplication().getScenarioManager().getNamesFileManager().saveNames();
	this.exitEditor();
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("Edit Names")) {
			...
			me.create();
			DungeonDiver3.getApplication().getScenarioManager().getNamesFileManager().loadNames();
			me.reSetUpGUI();
			me.edit();
		    }
